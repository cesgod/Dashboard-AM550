            ...
            <div class="modal-dialog modal-xlg modal-dialog-centered">
              <div class="modal-content">
                ...
                <?php
                  ...
                  var_dump($datealerts);
                  $querylg = mysqli_query($conexion, 'SELECT * FROM alertlogs');
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              ...
              <div class="count red crtqnt"></div>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-4  ">
                  ...
                  <div class="x_panel">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" readonly class="form-control" id="staticEmail" <?php echo('value="'.$crt_limit.'"');?>>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Marginal (%)</label>
                      <div class="col-sm-2">
                        <input type="text" readonly class="form-control" id="staticEmail" <?php echo('value="'.$wrn_limit.'"');?>>
                      </div>
                    </div>
                    <div class="x_title">
                ...
                <div class="col-md-6 col-sm-4  ">
                 <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Critico (+/-)</label>
                      <div class="col-sm-2">
                        <input type="text" readonly class="form-control" id="staticEmail" <?php echo('value="'.$crt_limitt.'"');?>>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Marginal (+/-)</label>
                      <div class="col-sm-2">
                        <input type="text" readonly class="form-control" id="staticEmail" <?php echo('value="'.$wrn_limitt.'"');?>>
                      </div>
                    </div>
                  <div class="x_panel">
                    <div class="x_title">
