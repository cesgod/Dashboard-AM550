    ...
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                ...
                datasets: [{
                    data: [15, 20, 30, 10, 30],
                    backgroundColor: ["#BDC3C7", "#9B59B6", "#E74C3C", "#df4759", "#3498DB"],
...
function init_sparklines() {
    void 0 !== jQuery.fn.sparkline && (console.log("init_sparklines"), $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        ...
        type: "pie",
        sliceColors: ["#df4759", "#ccc", "#75BCDD", "#D66DE2"]
        ...
        if ($("#canvasDoughnut").length) {
            ...
            var a = {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#df4759", "#3498DB"],
                    hoverBackgroundColor: ["#ffc107", "#B370CF", "#CFD4D8", "#36CAAB", "#49A9EA"]
                }]
            };
            new Chart(e, {
                type: "doughnut",
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        labels: ["Geekbench"],
        barRatio: .4,
        barColors: ["#df4759", "#ffc107", "#ACADAC", "#3498DB"],
        xLabelAngle: 35,
        hideHover: "auto",
        resize: !0
        ...
        lineColors: ["#df4759", "#ffc107", "#ACADAC", "#3498DB"],
        ...
        colors: ["#df4759", "#ffc107", "#ACADAC", "#3498DB"],
        formatter: function(e) {
            return e + "%"
        },
        resize: !0
    }), $("#grapsh_line").length && (Morris.Line({
        element: "graph_line",
        xkey: "year",
        ykeys: ["value"],
        labels: ["Value"],
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        var e = {
            color: ["#df4759", "#ffc107", "#BDC3C7", "#3498DB", "#9B59B6", "#8abb6f", "#759c6a", "#bfd3b7"],
            title: {
                itemGap: 8,
                textStyle: {
                    fontWeight: "normal",
        ...
        /*ECHART PIE*/
        if ($("#echart_pie_II").length) {
                $.ajax({
                url: "../../../../soap/valuesam550.php",
            ...
            var myCharte = echarts.init(document.getElementById("echart_pie_II"), e).setOption({
